...
# Excercise with Solar Orbiter Data
...
# visualize RGB leves with two different stretches. Lin is a linear funcion, hist exaggerate the tails
...
soc <- unsuperClass(so, nClasses=3) # in particular 3 classes, but it is customizable according to your data
cl <- colorRampPalette(c('yellow','black','red'))(100) # personalized color palette
plot(soc$map, col=cl) # plot using $ the 'rope' 

# Unsupervised Classification with 20 classes now
