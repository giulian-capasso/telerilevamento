...
\begin{document}
\begin{frame}
\titlepage  % Displaying the title page with the title, author, institute, and date
\end{frame}

% Table of Contents (Summary) with itemization
...
\vspace{0.5cm}
% Creating three columns within the frame
\begin{columns}
  \begin{column}{0.20\textwidth} % First column (20% of the frame width)
    \centering
    \includegraphics[width=\linewidth]{Exam/Inquadramento.png} % adding the image in the first column
  \end{column}
  \begin{column}{0.34\textwidth} % Second column (34% of the frame width)
    \centering
    \includegraphics[width=\linewidth]{Mappaincendicopernicus.png} % adding the image in the second column
  \end{column}
  \begin{column}{0.39\textwidth}  % Third column (39% of the frame width)
    \centering
    \includegraphics[width=\linewidth]{Exam/Mondello.png} % adding the image in the third column
  \end{column} 
\end{columns} % Close the columns environment
\vspace{0.5cm}
\small % Change the font size to small for the following text
% Adding text to explain the context and objectives of the project
...
\begin{frame}{Metodologia}
    ...
    \end{itemize}
    \vspace{0.5cm}
    \centering % Center-align the following content
    % Insert the first image with a caption
    \includegraphics[width=0.7\textwidth]{Exam/sentinel2b_bands.jpeg}
    {\tiny Sentinel-2B} % Add a caption below the image
    \vspace{0.2cm} % Add vertical space
    % Insert the second image with a caption
    \includegraphics[width=0.7\textwidth]{Exam/Landsat bands.png}
    {\tiny Landsat 8} % Add a caption below the image
\end{frame}
